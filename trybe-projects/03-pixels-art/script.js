...
elementSectionPalette.addEventListener("click", function(event) {
...
elementSectionPixel.addEventListener("click", function(event) {
...
function resetPixels() {
    ...
    for (let i = 0; i < pixels.length; i++) {
        elementSectionPixel.removeChild(pixels[i]);
    }
    for (let j = 0; j < br.length; j++) {
        elementSectionPixel.removeChild(br[j]);
    }
